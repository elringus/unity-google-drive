...
namespace Data
{
    ...
    public class FileList : GoogleDriveData
    {
        ...
        /// </summary>
        public bool IncompleteSearch { get { return incompleteSearch; } }
        /// <summary>
        ...
        /// </summary>
        public string NextPageToken { get { return nextPageToken; } }

        [SerializeField] private List<File> files = null;
        [SerializeField] private bool incompleteSearch = false;
        [SerializeField] private string nextPageToken = null;
    }
}
